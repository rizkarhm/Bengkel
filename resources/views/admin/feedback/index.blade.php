    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                                        ...
                                        <div class="col">
                                            <div class="rate p-0">
                                                <input type="radio" id="star5" class="rate" name="rating"
                                                    value="5" @if ($row->rating == 5) @checked(true) @endif
                                                    disabled /><label for="star5" title="text">5 stars</label>

                                                <input type="radio" id="star4" class="rate" name="rating"
                                                    value="4" @if ($row->rating == 4) @checked(true) @endif
                                                    disabled />
                                                <label for="star4" title="text">4 stars</label>

                                                <input type="radio" id="star3" class="rate" name="rating"
                                                    value="3" @if ($row->rating == 3) @checked(true) @endif
                                                    disabled /><label for="star3" title="text">3 stars</label>

                                                <input type="radio" id="star2" class="rate" name="rating"
                                                    value="2" @if ($row->rating == 2) @checked(true) @endif
                                                    disabled /><label for="star2" title="text">2 stars</label>

                                                <input type="radio" id="star1" class="rate" name="rating"
                                                    value="1" @if ($row->rating == 1) @checked(true) @endif
                                                    disabled /><label for="star1" title="text">1 stars</label>
                                            </div>
                                        </div>
            </div>
            </td>
            ...
            <td class="text-center">
                ...
                <button class="btn btn-danger ml-2" data-toggle="modal" data-target="#deleteModal-{{ $row->id }}"
                    class="delete-item">
                    Hapus
                </button>

                <div class="modal fade text-left" id="deleteModal-{{ $row->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="col">
                                <div class="rate p-0">
                                    <input type="radio" id="star5" class="rate" name="rating" value="5"
                                        @if ($row->rating == 5) @checked(true) @endif disabled /><label
                                        for="star5" title="text">5 stars</label>

                                    <input type="radio" id="star4" class="rate" name="rating" value="4"
                                        @if ($row->rating == 4) @checked(true) @endif disabled />
                                    <label for="star4" title="text">4 stars</label>

                                    <input type="radio" id="star3" class="rate" name="rating" value="3"
                                        @if ($row->rating == 3) @checked(true) @endif disabled /><label
                                        for="star3" title="text">3 stars</label>

                                    <input type="radio" id="star2" class="rate" name="rating" value="2"
                                        @if ($row->rating == 2) @checked(true) @endif disabled /><label
                                        for="star2" title="text">2 stars</label>

                                    <input type="radio" id="star1" class="rate" name="rating" value="1"
                                        @if ($row->rating == 1) @checked(true) @endif disabled /><label
                                        for="star1" title="text">1 stars</label>
                                </div>
                            </div>
        </div>
        <td>{{ $row->feedback }}</td>
